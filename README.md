...
This project simulates an internal network penetration test scenario.
All commands and outputs are safely simulated  no real tools or system processes are executed.
